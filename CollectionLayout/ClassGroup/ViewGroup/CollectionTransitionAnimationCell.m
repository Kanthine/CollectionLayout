//
//  CollectionTransitionAnimationCell.m
//  CollectionLayout
//
...
@interface CollectionTransitionAnimationCell ()
@property (nonatomic ,strong) UIImageView *imageView;
@property (nonatomic ,strong) UILabel *nameLable;
@end
@implementation CollectionTransitionAnimationCell
...
- (void)layoutSubviews{
    ...
    self.imageView.frame = CGRectMake(0, 0, contentWidth, contentHeight - 40);
...
- (UIImageView *)imageView{
    if (_imageView == nil) {
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 42, 42)];
